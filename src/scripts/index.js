...
const explore__wrapper = document.querySelector(".explore__wrapper"),
...
const carouselData = [
  ...
  },
  {
    ...
    clientImage: "https://picsum.photos/id/233/500/500",
  },
  {
    id: Date.now(),
    title: "What Our Customers About Us saying",
    ...
    clientImage: "https://picsum.photos/id/231/500/500",
  },
  {
    id: Date.now(),
    title: "What Our Customers About Us saying",
    ...
    clientImage: "https://picsum.photos/id/235/500/500",
  },
];
...
let intro = document.querySelector(".intro_wrapper");
...
window.addEventListener("scroll", (e) => {
  ...
  if (scrollY > 232) {
    header.classList.add("top-0", "w-full", "bg-white", "z-10", "duration-500");
  } else {
